...
log.info('data_validation directory created')
...
if os.path.exists(data_validation.data_local_file)  :
    ...
    with open( data_validation.data_validation_status_file,'r' ) as file :
        ...
        if  'True' in data_validation_status :
            ...
            log.info('Data is not validated')
        else:
            log.info('Something wrong with the data')
...
log.info('Model Training is completed')
...
log.info(f'model r2 : {r2} model mse : {mse}')
